...
#define STRING_CONFIG_H_AUTHOR "Jaylen Young" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Boiler Up!"
 ...
 *   PRUSA_MMU2S     : Průša MMU2S (Requires MK3S extruder with motion sensor, EXTRUDERS = 5)R
...
#define HOTEND_OFFSET_X { 0.0, 15.72 } // (mm) relative X-offset for each nozzle
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.5, 100.5, 400, 415}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2400, 2000, 100, 10000 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 266  // Y point for Z homing
#endif
